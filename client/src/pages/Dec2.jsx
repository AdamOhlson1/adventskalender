    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}`, {
        ...
        body: JSON.stringify({
          email: email,
          guess: isCorrect
            ? "Fysiskt på destination och på Sharepoint"
            : "Wrong answer", // Anpassa gissningens logik
          isCorrect: isCorrect,
        }),
      });
  ...
  return (
    ...
    >
      ...
      {showQuestion && (
        ...
        >
          <h2 style={{ fontWeight: "bold" }}>Fråga för den 2:a december:</h2>
          ...
          >
            ...
            >
              Fråga 2: Var bör man hitta ESS Krispärm?
            </p>
            <div>
              <button
                style={{
              ...
              <button
                ...
                disabled={guessResult !== null}
              >
                På Sharepoint och på Beekeeper
              </button>
            </div>
          </div>
        </div>
