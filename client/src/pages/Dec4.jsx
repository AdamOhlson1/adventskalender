    ...
    try {
      const response = await fetch(`${process.env.REACT_APP_API_URL}`, {
        ...
        body: JSON.stringify({
          email: email,
          guess: isCorrect
            ? "Att blockera obehörig åtkomst och skydda nätverket från externa hot"
            : "Wrong answer", // Här kan du anpassa din svarshantering
          isCorrect: isCorrect,
        }),
      });
  ...
  return (
    ...
    >
      ...
      {showQuestion && (
        ...
        >
          <h2 style={{ fontWeight: "bold" }}>Fråga för den 4:e december:</h2>
          ...
          >
            ...
            >
              Fråga 4: Vilken funktion har en brandvägg i ett nätverk?
            </p>
            <div>
              <button
                style={{
              ...
              >
                Att blockera obehörig åtkomst och skydda nätverket från externa
                hot
              </button>
              <button
                style={{
                ...
                disabled={guessResult !== null}
              >
                Att öka hastigheten på internetanslutningen
              </button>
              ...
              <button
                ...
                disabled={guessResult !== null}
              >
                Att lagra säkerhetskopior av data
              </button>
            </div>
          </div>
        </div>
